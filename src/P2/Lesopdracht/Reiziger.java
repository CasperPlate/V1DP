...
public class Reiziger {
	...
	public void voegOVChipkaartToe(int kaartNummer, java.sql.Date geldigTot, int klasse, double saldo) {
		deKaarten.add(new OVChipkaart(kaartNummer, geldigTot, klasse, saldo, this.reizigerID));
	}
